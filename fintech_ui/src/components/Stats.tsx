...
export default function Stats() {
  ...
  return (
    <section id="stats" className="py-32 px-6 bg-gradient-to-b from-black to-indigo-900/20 w-full mt-12 border-t border-white/5">
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center">
        ...
        >
          ...
          <p className="text-indigo-200/80 mb-20 max-w-xl text-lg md:text-xl font-light leading-relaxed mx-auto">
          ...
          {stats.map((stat, index) => (
            ...
            >
              <div className="absolute top-6 right-6">
                <ArrowUpRight size={20} className="text-white/40 group-hover:text-indigo-400 group-hover:translate-x-1 group-hover:-translate-y-1 transition-all duration-300" strokeWidth={1.5} />
              </div>
