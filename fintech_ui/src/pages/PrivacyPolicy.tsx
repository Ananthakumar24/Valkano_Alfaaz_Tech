export default function PrivacyPolicy() {
  return (
    <div className="flex flex-col w-full pt-32 px-6 max-w-4xl mx-auto pb-24 text-gray-300">
      <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-white mb-8">Privacy Policy</h1>
      ...
      <div className="space-y-8 text-base leading-relaxed">
        <section>
          ...
          <p>
            Welcome to Valkano Alfaaz Technologies. We respect your privacy and are committed to protecting your personal data. 
